...
# elements O
# elements Z
#       C       Ca       Cl           H             Mg      N            Na           Si       O       Z
D = [1.0e-9, 1.0e-9, 2.032*1.0e-9, 9.311*1.0e-9, 1.0e-9, 1.902*1.0e-9,1.334*1.0e-9, 1.0e-9, 1.0e-9, 1.0e-9]         # diffusion coefficient (in units of m2/s)
...
#     p2.legend.click_policy = 'mute'
    ...
    p3.line(x='x', y='Clanion', color='blue', line_width=2, legend_label='Cl-', source=source)
    p3.line(x='x', y='Nacation', color='orange', line_width=2, legend_label='Na+', source=source)
    p3.line(x='x', y='NO3anion', color='green', line_width=2, legend_label='NO3-', source=source)
...
#                         dolomite=new_source.data['dolomite'],
                        ...
                        Cacation=new_source.data['Clanion'],
                        Mgcation=new_source.data['Nacation'],
                        HCO3anion=new_source.data['NO3anion'],
